...
Results
Trend following is the most robust and profitable; mean reversion underperforms in trending markets; AR model achieves moderate profitability.

2. Time Series Analysis of SPY and SPTL
...
Guassianity, stationarity, and cointegration tests
